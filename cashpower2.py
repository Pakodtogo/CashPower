...
def client_non_pam(M, Ec, PF, Rd, TQR):
            if Ec <= 50:
                ...
                elif (M)/(T1+3) + Ec > 50 and (M - (2 * Ec) - ((T2 - T1) * (Ec - 50)))/(T2+5) <= 50:
                    Ep = 50 - Ec
                    Tdep = 2 * Ep
                    Tsdaaep = Ep
                    TVAp = 0
                ...
                elif 50 < (M - (2 * Ec) - ((T2 - T1) * (Ec - 50))) / (T2 + 5) + Ec <= 150:
                    Ea = (M - (2 * Ec) - ((T2 - T1) * (Ec - 50))) / (T2 + 5)
                    TVA = 0
                    Tsdaae = (3 * Ea) + (2 * Ec)
                    Tde = 2 * Ea
                    CEa = (Ea * T2) + ((Ec - 50) * (T2 - T1))

                elif (M - (2 * Ec) - ((T2 - T1) * (Ec - 50)))/(T2+5) + Ec > 150 and  (M - Ttva * ((PF + Rd) + (T2 + 5) * (Ec - 150)) - (Ec - 50) * (T2 - T1) - 2 * Ec) / ((T2 + 5) + Ttva * (T2 + 5)) + Ec <= 150:
                    Ep = 150 - Ec
                    Tdep = 2 * Ep
                    Tsdaaep = 3*Ep + 2*Ec
                    TVAp = 0
                    CEp = (50-Ec)*T1 + (Ep+Ec-50)*T2
                    M1 = Ep*(T2+5) + (2 * Ec) + ((T2 - T1) * (Ec - 50))
                    Ms = M - M1
                    #if (Ms) < 2*(Ep) + 0.1*(T2+5) : print("Monnaie =", Ms, "FCFA")    #Ce qui est toujours le cas
                    SA = Ttva*(PF+Rd) - Ms + 0.1*(T2+5 + Ttva*(T2+5))
                    print("\nVous ajoutez ", SA + calcul_TQR(M1+Ms+SA))
                    MA = float(input("\nEntrer la somme ajoutee: "))
                    if MA >= SA + calcul_TQR(M1+Ms+SA):
                        Ms = Ms + SA
                        Es = (Ms-Ttva*(PF+Rd))/(T2+5 + Ttva*(T2+5))
                        Tdes = 2*Es
                        Tsdaaes = 3*Es
                        TVAs = Ttva * (PF + Rd + Es * (T2 + 5))
                        CEs = Es*T3
                        TQR = calcul_TQR (Ms+M1)
                        M = Ms+M1 + TQR
                        Ea = Ep + Es
                ...
                elif 150 < (M - Ttva * ((PF + Rd) + (T2 + 5) * (Ec - 150)) - (Ec - 50) * (T2 - T1) - 2 * Ec) / ((T2 + 5) + Ttva * (T2 + 5)) + Ec <= 200:
                    Ea = (M - Ttva * ((PF + Rd) + (T2 + 5) * (Ec - 150)) - (Ec - 50) * (T2 - T1) - 2 * Ec) / ((T2 + 5) + Ttva * (T2 + 5))
                    TVA = Ttva * (PF + Rd + (Ec - 150) * (T2 + 5) + Ea * (T2 + 5))
                    Tsdaae = (3 * Ea) + (2 * Ec)
                    Tde = 2 * Ea
                    CEa = (Ea * T2) + ((Ec - 50) * (T2 - T1))
                else:
                    Ea = (M - (2 * Ec) - Ttva * (PF + Rd + (50 * T2) + (Ec - 200) * T3 + (Ec - 150) * 5) - (Ec - 200) * T3 - (150 * T2) - (50 - Ec) * T1) / ((T3 + 5) + Ttva * (T3 + 5))
                    Tsdaae = (3 * Ea) + (2 * Ec)
                    Tde = 2 * Ea
                ...
                elif M/(T2+5) + Ec > 150 and (M - Ttva * (PF + Rd + (Ec - 150) * (T2 + 5))) / ((T2 + 5) + Ttva * (T2 + 5)) + Ec <= 150:
                    Ep = 150 - Ec
                    Tdep = 2 * Ep
                    Tsdaaep = 3*Ep
                    TVAp = 0
                    CEp = Ep*T2
                    M1 = Ep*(T2+5) + ((T2 - T1) * (Ec - 50))
                    Ms = M - M1
                    SA = Ttva*(PF+Rd) - Ms + 0.1*(T2+5 + Ttva*(T2+5))
                    print("\nVous ajoutez ", SA + calcul_TQR(M1+Ms+SA))
                    MA = float(input("\nEntrer la somme ajoutee: "))
                ...
                elif 150 < (M - Ttva * (PF + Rd + (Ec - 150) * (T2 + 5))) / ((T2 + 5) + Ttva * (T2 + 5)) + Ec <= 200:
                    Ea = (M - Ttva * (PF + Rd + (Ec - 150) * (T2 + 5))) / ((T2 + 5) + Ttva * (T2 + 5))
                    Tde = 2 * Ea
                    Tsdaae = 3 * Ea
                    TVA = Ttva * (PF + Rd + (Ec - 150) * (T2 + 5) + Ea * (T2 + 5))
                    CEa = Ea * T2
                else:
                    Ea = (M - (Ec - 200) * (T3 - T2) - Ttva * (PF + Rd + (50 * T2) + (Ec - 200) * T3 + (Ec - 150) * 5)) / ((T3 + 5) + Ttva * (T3 + 5))
                    Tde = 2 * Ea
                    Tsdaae = 3 * Ea
                ...
                if (M) / ((T2 + 5) + Ttva * (T2 + 5)) + Ec <= 200:
                    ...
                    Ea = (M - (Ttva * (Ec - 200) * (T3 - T2)) - (Ec - 200) * (T3 - T2)) / ((T3 + 5) + Ttva * (T3 + 5))
                    Tde = 2 * Ea
                    Tsdaae = 3 * Ea
...
def client_pam(M, TQR, PF, Rd, dd):
    ...
    elif (M-PF-Rd)/(T1+3) > 50 and (M-PF-Rd-(50*T1)+(50*T2))/(T2+5) <= 50:
        Ep =50
        Tdep = 2 * Ep
        Tsdaaep = Ep
        TVAp = 0
...
def agent_non_pam(M, Ec, TQR, PF, Rd, Seuil):
    if Ec <= 50:
        if Ec + (M) / 3 <= 50:
        ...
        elif Ec + (M - 2 * Ec) / 5 > 150 and (M - Ttva * (5 * Ec - 750) - 2 * Ec) / (5 + (5 * Ttva)) + Ec <= 150:
            Ep = 150 - Ec
            Tdep = 2 * Ep
            Tsdaaep = 3*Ep + 2*Ec
            TVAp = 0
        ...
        elif 150 < (M - Ttva * (5 * Ec - 750) - 2 * Ec) / (5 + (5 * Ttva)) + Ec <= Seuil:
            Ea = (M - Ttva * (5 * Ec - 750) - 2 * Ec) / (5 + (5 * Ttva))
            TVA = Ttva * (5 * Ec - 750 + 5 * Ea)
            Tsdaae = 3 * Ea + 2 * Ec
            Tde = Ea * 2
            CEa = 0
            
        
        #elif (M - Ttva * (5 * Ec - 750) - 2 * Ec) / (5 + (5 * Ttva)) + Ec > Seuil and (Ec + (M - Ttva * (Ec * T4 - Seuil * T4 + 5 * Ec - 750) - 2 * Ec - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (5 + T4))) <= Seuil:
            '''Ep = Seuil - Ec
            Tdep = 2 * Ep
            Tsdaaep = 3*Ep + 2*Ec
            TVAp = Ttva * (5 * Ec - 750 + 5 * Ep)
            CEp = 0
            M1 = Ep*(5 + 5*Ttva) + Ttva*(5*Ec-750) + 2*Ec
            TQR = calcul_TQR(M1)
            M2 = Ep*(5 + 5*Ttva) + Ttva*(5*Ec-750) + 2*Ec
            Ms = M - M1
            Es = (M) / ((T4 + 5) + Ttva * (5 + T4))
            Tdes = 2*Es
            Tsdaaes = 3*Es
        ...
        elif Seuil < (Ec + (M - Ttva * (Ec * T4 - Seuil * T4 + 5 * Ec - 750) - 2 * Ec - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (5 + T4))) <= (Seuil + 150):
            Ea = (M - Ttva * (Ec * T4 - Seuil * T4 + 5 * Ec - 750) - 2 * Ec - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (5 + T4))
            TVA = Ttva * (T4 * Ec - Seuil * T4 + 5 * Ec - 750 + Ea * (T4 + 5))
            Tsdaae = 3 * Ea + 2 * Ec
            Tde = Ea * 2
            CEa = Ea * T4 + (Ec - Seuil) * T4
        
        #elif (Ec + (M - Ttva * (Ec * T4 - Seuil * T4 + 5 * Ec - 750) - 2 * Ec - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (5 + T4))) > (Seuil + 150)   and   (M - 2 * Ec - Ttva * (150 * T4 + (Ec - (Seuil + 150)) * T5 + (Ec - 150) * 5) - (Ec - (Seuil + 150)) * T5 - 150 * T4) / ((T5 + 5) + Ttva * (5 + T5)) + Ec <= (Seuil+ 150):
            '''Ep = (Seuil+150) - Ec
            Tdep = 2 * Ep
            Tsdaaep = 3*Ep + 2*Ec
            TVAp = Ttva * (T4 * Ec - Seuil * T4 + 5 * Ec - 750 + Ep * (T4 + 5))
            CEp = Ea * T4 + (Ec - Seuil) * T4
            M1 = Ep*((T4+5) + (T4+5)*Ttva) + Ttva*(Ec*T4-Seuil*T4+5*Ec-750) + 2*Ec + (Ec - Seuil) * T4 
            TQR = calcul_TQR(M1)
            Ms = M - M2
            ...
            Ea = (M - 2 * Ec - Ttva * (150 * T4 + (Ec - (Seuil + 150)) * T5 + (Ec - 150) * 5) - (Ec - (Seuil + 150)) * T5 - 150 * T4) / ((T5 + 5) + Ttva * (5 + T5))
            TVA = Ttva * (150 * T4 + (Ec - (Seuil + 150)) * T5 + (Ec - 150) * 5 + Ea * (T5 + 5))
            Tsdaae = 3 * Ea + 2 * Ec
            Tde = Ea * 2
        ...
        if Ec + (M) / 5 <= 150:
        ...
        elif Ec + (M) / 5 > 150 and (M - Ttva * (5 * Ec - 750)) / (5 + (5 * Ttva)) + Ec <= 150:
            Ep = 150 - Ec
            Tdep = 2 * Ep
            Tsdaaep = 3*Ep
            TVAp = 0
        ...
        elif 150 < Ec + (M - Ttva * (5 * Ec - 750)) / (5 + (Ttva * 5)) <= Seuil:
            Ea = (M - Ttva * (5 * Ec - 750)) / (5 + (Ttva * 5))
            Tde = 2 * Ea
            Tsdaae = 3 * Ea
            TVA = Ttva * (5 * Ec - 750 + 5 * Ea)
            CEa = 0

        #elif (M - Ttva * (5 * Ec - 750)) / (5 + (5 * Ttva)) + Ec > Seuil    and    (Ec + (M - Ttva * (Ec * T4 - Seuil * T4 + 5 * Ec - 750) - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (5 + T4))) <= Seuil:
            '''Ep = Seuil - Ec
            Tdep = 2 * Ep
            Tsdaaep = 3*Ep + 2*Ec
            TVAp = Ttva * (5 * Ec - 750 + 5 * Ep)
        ...
        elif Seuil < Ec + (M - Ttva * ((Ec - Seuil) * T4 + (Ec - 150) * 5) - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (T4 + 5)) <= (Seuil + 150):
            Ea = (M - Ttva * ((Ec - Seuil) * T4 + (Ec - 150) * 5) - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (T4 + 5))
            Tde = 2 * Ea
            Tsdaae = 3 * Ea
            TVA = Ttva * ((Ec - Seuil) * T4 + (Ec - 150) * 5 + Ea * (T4 + 5))
            CEa = Ea * T4 + (Ec - Seuil) * T4

        #elif (Ec + (M - Ttva * (Ec * T4 - Seuil * T4 + 5 * Ec - 750) - (Ec - Seuil) * T4) / ((T4 + 5) + Ttva * (5 + T4))) > (Seuil + 150)   and   (M - Ttva * (150 * T4 + (Ec - (Seuil + 150)) * T5 + (Ec - 150) * 5) - (Ec - (Seuil + 150)) * T5 - 150 * T4) / ((T5 + 5) + Ttva * (5 + T5)) + Ec <= (Seuil+ 150):
            '''Ep = (Seuil+150) - Ec
            Tdep = 2 * Ep
            Tsdaaep = 3*Ep
            TVAp = Ttva * (T4 * Ec - Seuil * T4 + 5 * Ec - 750 + Ep * (T4 + 5))
            CEp = Ea * T4 + (Ec - Seuil) * T4
            M1 = Ep*((T4+5) + (T4+5)*Ttva) + Ttva*(Ec*T4-Seuil*T4+5*Ec-750) + (Ec - Seuil) * T4
            TQR = calcul_TQR(M1)
            Ms = M - M1
            Es = (M) / ((T5 + 5) + Ttva * (5 + T5))
            Tdes = 2*Es
            ...
            Ea = (M - Ttva * (150 * T4 + (Ec - (Seuil + 150)) * T5 + (Ec - 150) * 5) - (Ec - (Seuil + 150)) * T5 - 150 * T4) / ((T5 + 5) + Ttva * (T5 + 5))
            Tde = 2 * Ea
            Tsdaae = 3 * Ea
            TVA = Ttva * (150 * T4 + (Ec - (Seuil + 150)) * T5 + (Ec - 150) * 5 +  Ea * (T5 + 5))
