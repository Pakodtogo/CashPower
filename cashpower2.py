...
def main():
    ...
    # Demandez à l'utilisateur d'entrer la date du dernier achat (au format YYYY-MM-DD)
    date_dernier_achat_str = input("Entrez la date du dernier achat (YYYY-MM-DD) : ")
    ...
    if est_premier_achat_du_mois(date_dernier_achat):
        ...
        Ec = float(input("Entrez Le cumul d'énergie payee anterieurement dans le mois: "))
        ...
        if CT == 17032:
            ...
            #calculate_invoice(M, Ec, PF, Rd, TQR)
        
        else:
            print("La valeur que vous avez entree ne correspond a aucun code tarif de compteur triphase!")
            return 1
        Taxes = TQR + TVA + Tsdaae + Tde


    if M - Taxes < 0:
        print("Vous ne pouvez pas acheter des unites! Vous avez un credit de" ,  Taxes , "FCFA avant d'avoir droit à des unites")
    else:
        print("\n Redevance : ", Rd, "\n")
        print("Prime Fixe : ", PF, "\n")
        print("Tsdaae : ", Tsdaae, "\n")
